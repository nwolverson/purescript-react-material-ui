...
inputStyle :: Option ToggleOption (UnknownType)
inputStyle = opt "inputStyle" -- object
label :: Option ToggleOption (Node)
label = opt "label"
...
thumbSwitchedStyle :: Option ToggleOption (UnknownType)
thumbSwitchedStyle = opt "thumbSwitchedStyle" -- object
toggled :: Option ToggleOption (Boolean)
toggled = opt "toggled"
trackStyle :: Option ToggleOption (UnknownType)
trackStyle = opt "trackStyle" -- object
trackSwitchedStyle :: Option ToggleOption (UnknownType)
trackSwitchedStyle = opt "trackSwitchedStyle" -- object
