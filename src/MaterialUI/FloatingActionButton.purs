...
className :: Option FloatingActionButtonOption (String)
...
mini = opt "mini"
onClick :: Option FloatingActionButtonOption (EventHandlerOpt)
onClick = opt "onClick"
...
zDepth :: Option FloatingActionButtonOption (UnknownType)
