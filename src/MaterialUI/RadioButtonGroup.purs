...
defaultSelected :: Option RadioButtonGroupOption (UnknownType)
defaultSelected = opt "defaultSelected" -- any
...
valueSelected :: Option RadioButtonGroupOption (UnknownType)
valueSelected = opt "valueSelected" -- any
